...
# global variable
base_model_path = '/disk1/fujm/photomaker_model/RealVisXL_V4.0'
...
photomaker_ckpt = '/disk1/fujm/photomaker_model/PhotoMaker-V2/photomaker-v2.bin'
...
adapter = T2IAdapter.from_pretrained(
    "/disk1/fujm/photomaker_model/t2i-adapter-sketch-sdxl-1.0", torch_dtype=torch_dtype, variant="fp16"
).to(device)
