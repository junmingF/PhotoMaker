...
def parse_args():
    ...
    parser.add_argument("--csv_file", type=str, default="/disk1/fjm/LLM/xlsx/0713_with_sentence-thking.xlsx",
    ...
    parser.add_argument("--output_folder", type=str, default="/disk1/fjm/resultimg/maker/test4_0-1500",
                        help="Directory to save generated images")
    parser.add_argument("--start_row", type=int, default=1,
                        help="1-based index of the first row to process (inclusive)")
    parser.add_argument("--end_row", type=int, default=1500,
    ...
    parser.add_argument("--cuda_device", type=int, default=3,
                        help="CUDA device index, e.g., 0 for cuda:0, 1 for cuda:1")
...
def main():
    ...
    # Prepare face detector（指定ctx_id）
    face_detector = FaceAnalysis2(
        providers=['CUDAExecutionProvider'],
        allowed_modules=['detection', 'recognition']
    )
    face_detector.prepare(ctx_id=args.cuda_device, det_size=(640, 640))
    ...
    for idx, row in df.iterrows():
        try:
            ...
            prompt_text = f"img of : {str(row[5])}"   # 第6列，前缀拼接trigger word
        except Exception:
